  ...
  return (
    <header className="flex justify-between items-center gap-[20px]">
      ...
      <nav className="flex items-center gap-[12px]">
        <span className="cart-button inline-block p-[8px] text-2xl border-[2.8] rounded-[50px] border-(--border-color) text-(--text-color) cursor-pointer hover:bg-(--button-color) hover:text-(--text-hover-color) hover:opacity-100 opacity-70 transition delay-[5]">
          <IoBagOutline />
        </span>
